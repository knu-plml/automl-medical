...
1. Login to AWS
---
2. Serch for 'Autopilot' on the search bar
![9](https://github.com/knu-plml/automl-medical/assets/89115326/aafc847b-f56f-4fea-b662-52a0902e9f68)
---
3. Click 'Set up for single user'. It will several miniute to finish.
![10](https://github.com/knu-plml/automl-medical/assets/89115326/25ffb5ee-e0d9-4c52-b0fc-337918c9808f)
---
4. After it is done, a domain will autometically created. Click 'Domains' from toolbar from the left and click on your domain. Click 'Launch' and choose 'Studio'.
...
---
6. Click 'Open in Canvas'(If you don't have 'Open in Canvas', you will instead have a 'Create' butten. Create and open it.)
...
---
9. Click 'Create dataset' on the top rigth corner.
...
---
11. Select the dataset that want to analyze(ex:cardio.csv) from your desktop and Click 'Preview dataset'. after check the dataset, create dataset
![7](https://github.com/knu-plml/automl-medical/assets/89115326/88429850-baea-414b-88b9-a36f1ca2482f)
---
12. After successfuly create a dataset, select your dataset and click 'Select dataset'
![8](https://github.com/knu-plml/automl-medical/assets/89115326/9dc8e769-9981-40b3-83e5-68ad02f6a824)
---
13. Choose the target column(ex:cardio) from 'Select a column to predict' and choose the columns that want to use from below and click 'Quick build'
...
---
14. Check your result from 'Analyze' tab
